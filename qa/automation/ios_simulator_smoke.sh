...
BUNDLE_ID="${PLUSHPAL_IOS_BUNDLE_ID:-com.toytalk.app}"
APP="${PLUSHPAL_IOS_SIMULATOR_APP:-$PUBLIC_ROOT/artifacts/ios/ToyTalk-iPhoneSimulator.app}"
...
echo "Installing and launching ToyTalk..."
