...
$Output = Join-Path $Root "dist\windows\PlushBuddy-$Version"
...
Copy-Item (Join-Path $Root "target\release\plushpal-desktop-host.exe") (Join-Path $Output "PlushBuddy Hub.exe")
