...
public-repo hygiene checks, and no provider key was present in the environment.
A July 5 local smoke later verified Hub Cloud AI mode with a stored Gemini key
and Android child-mode typed chat through Hub/Gemini.
